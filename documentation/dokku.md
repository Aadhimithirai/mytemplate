...
```
dokku config:set mytemplate MYTEMPLATE_ENV=prod FLASK_APP=manage.py
...
# dokku config:set mytemplate MYTEMPLATE_ENV=prod

dokku config:set mytemplate MAIL_USERNAME='' MAIL_PASSWORD='' MAIL_DEFAULT_SENDER="mytemplate\ <mytemplate@mytemplate.com>"
