...
from mytemplate.forms.login import LoginForm, SignupForm, RequestPasswordResetForm, ChangePasswordForm
...
from mytemplate.mailers.auth import ConfirmEmail, ResetPassword
from mytemplate.extensions import login_manager, token, limiter
