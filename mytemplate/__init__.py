...
from mytemplate import assets
from mytemplate import constants
from mytemplate.models import db
from mytemplate.api.resources import api_blueprint
from mytemplate.api import handle_api_error
from mytemplate.controllers.main import main
from mytemplate.controllers.auth import auth
from mytemplate.controllers.oauth import google_blueprint
from mytemplate.controllers.store import store
from mytemplate.controllers.settings import settings_blueprint
from mytemplate.controllers.admin.jobs import jobs
from mytemplate.controllers.webhooks.stripe import stripe_blueprint
from mytemplate.controllers.dashboard import dashboard_blueprints

from mytemplate import utils
from mytemplate.helpers import view as view_helpers
from mytemplate.converter import custom_converters
from mytemplate.extensions import (
    admin,
    assets_env,
    cache,
    csrf,
...
def create_app(object_name):
    ...
    Arguments:
        object_name: the python path of the config object,
                     e.g. mytemplate.settings.ProdConfig
    """
